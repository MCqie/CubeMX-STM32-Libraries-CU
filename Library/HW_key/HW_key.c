...
{
    //读出行扫描状态
    Key_row[0] = HAL_GPIO_ReadPin(HW_GPIO,HW_RW0)<<3;
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(HW_GPIO,HW_RW1)<<2);
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(HW_GPIO,HW_RW2)<<1);
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(HW_GPIO,HW_RW3));
